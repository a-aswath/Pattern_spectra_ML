...
def save_preprocessed_data( preprocessed, labels, ds_name, test, parent_dir):
    if test:
        ds_path = os.path.join(parent_dir, "data\\preprocessed", ds_name, "test")
    else:
        ds_path = os.path.join(parent_dir, "data\\preprocessed", ds_name, "train")
    os.mkdir(ds_path)
